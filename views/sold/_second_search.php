...
<?php $form = ActiveForm::begin([
    'action' => ['sold-products-report'],
    'method' => 'get',
]); ?>
<div class="row">
    <div class="col-6">
        <?= $form->field($model, 'seller_id')->widget(Select2::className(), [
            'data' => ArrayHelper::map(\app\models\Users::find()->asArray()->all(), 'id', 'first_name'),
            'theme' => Select2::THEME_BOOTSTRAP,
            'size' => Select2::SIZE_SMALL,
            'options' => ['placeholder' => 'Sotuvchini tanlang', 'class' => 'input-items'],
            'pluginOptions' => [
                'allowClear' => true,
            ],
        ]);  ?>
...
<div class="row">
    ...
    <div class="col-6">
        <?= $form->field($model, 's_price')->widget(MaskMoney::classname(), [
            'pluginOptions' => [
                'prefix' => 'UZS ',
                'precision' => 0
            ],
...
<div class="form-group">
    ...
    <?= Html::resetButton('Print', ['class' => 'btn btn-success', 'id' => 'printIt']) ?>
</div>
